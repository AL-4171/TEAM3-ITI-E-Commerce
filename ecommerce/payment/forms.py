...
class PaymentForm(forms.Form):
    ...
    def clean(self):
        ...
        if method == 'credit_card':
            ...
            if not card_number or len(card_number) != 14 or not card_number.isdigit():
                self.add_error('card_number', 'Card number must be exactly 14 digits.')
